...
public class FileOperation {
    ...
    public static void main(String[] args) throws java.io.IOException {
        ...
        while (true) {
            ...
            if (command.get(0).equals("cd")){
                File NewDirectory = new File (command.get(1));
                if (NewDirectory.exists()){
                    currentDirectory = NewDirectory;
                }else {
                    System.out.println("No such directory, please retry.");
                }
                continue;
            }
            ...
            if (command.get(0).equals("display")){
            ...
            // TODO: implement code to handle find here
                ...
                if (Java_find(currentDirectory, command.get(1))){
                    ...
                    printout(currentDirectory, command.get(1));
                }
                else{
    ...
    public static void printout(File dir, String name) {
